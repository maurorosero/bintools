# Plantilla para Reporte de Issues

¡Gracias por ayudarnos a mejorar MRDevs Tools!

Por favor, completa la siguiente información para reportar un error o solicitar una nueva funcionalidad.
...
- [ ] Error (Bug)
- [ ] Solicitud de nueva funcionalidad (Feature request)
- [ ] Mejora o optimización
...
2. Ejecutar el script bin/setup.sh
3. Observar el error en la sección de instalación de paquetes
...
Completa la información de tu entorno:

- Sistema operativo: (ejemplo: Debian 12, Windows 11, etc.)
- Versión del proyecto: (ejemplo: v1.2.3)
- Versión de herramientas relacionadas: (ejemplo: Podman 4.6.1, Python 3.11, etc.)
...
¡Gracias por colaborar con MRDevs Tools! 🚀
