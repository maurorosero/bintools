...
¡Gracias por tu contribución a MRDevs Tools!

Por favor, completa la siguiente información para ayudar a revisar tu Pull Request de manera eficiente.
...
- [ ] [REFACTORED] Refactorización de código (sin cambios de comportamiento)
- [ ] [DOCS] Cambios en documentación
- [ ] [SOPS] Actualizaciones relacionadas a gestión de secretos
...
Si la respuesta es sí, asegúrate de actualizar la documentación relevante antes de solicitar la revisión.
