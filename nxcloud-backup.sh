...
configure_secure_sync() {
    ...
    echo "================================="
    echo ""
    echo "ℹ️  IMPORTANTE: Nextcloud no soporta la configuración automática de carpetas"
    echo "   por seguridad y estabilidad. Debes configurarla manualmente."
    echo ""
    ...
    echo "   • Haz clic derecho en el icono de Nextcloud en la bandeja del sistema"
    echo "   • Selecciona 'Configuración' o 'Settings'"
    echo "   • Ve a la pestaña 'Cuentas' o 'Accounts'"
    echo ""
    echo "3. 📁 Agregar nueva carpeta:"
    echo "   • Haz clic en 'Añadir carpeta de sincronización' o 'Add folder sync connection'"
    echo "   • Navega hasta: $secure_dir"
    echo "   • Selecciona la carpeta 'secure'"
    echo ""
