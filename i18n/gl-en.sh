...
# Version: 0.1.0
#
# gl-en.sh - Description placeholder
# -----------------------------------------------------------------------------
#
...
# English language file for GitLab CLI Installer
# License: AGPL-3.0
...
TRANSLATIONS["msg_banner_title"]="GitLab CLI Installer"
TRANSLATIONS["msg_banner_subtitle"]="MR*Developer Tools"
TRANSLATIONS["msg_start"]="Starting GitLab CLI installation..."
...
TRANSLATIONS["msg_install_deps"]="Installing dependencies..."
TRANSLATIONS["msg_deps_fail"]="Failed to install dependencies. Please install them manually."
TRANSLATIONS["msg_system_success"]="System check completed successfully."
TRANSLATIONS["msg_install_glab"]="Installing GitLab CLI..."
...
TRANSLATIONS["msg_install_unsupported"]="Unsupported package manager. Please install GitLab CLI manually."
TRANSLATIONS["msg_install_success"]="GitLab CLI installed successfully!"
TRANSLATIONS["msg_install_fail"]="GitLab CLI installation failed. Please try installing manually."
TRANSLATIONS["msg_usage_intro"]="GitLab CLI has been installed. Here are some common commands:"
TRANSLATIONS["msg_auth_section"]="Authentication:"
TRANSLATIONS["msg_repo_section"]="Repository operations:"
TRANSLATIONS["msg_mr_section"]="Merge requests and issues:"
TRANSLATIONS["msg_help_section"]="For more information:"
TRANSLATIONS["msg_docs_link"]="For complete documentation, visit: https://gitlab.com/gitlab-org/cli/-/blob/main/docs/index.md"
TRANSLATIONS["msg_complete"]="Installation completed successfully!"
TRANSLATIONS["msg_no_pkg_manager"]="No supported package manager found. Please install GitLab CLI manually."